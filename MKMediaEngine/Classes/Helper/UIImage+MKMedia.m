...
@implementation UIImage (MKMedia)

static inline CGRect MKCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode) {
...
{
    CGRect drawRect = MKCGRectFitWithContentMode(rect, self.size, contentMode);
